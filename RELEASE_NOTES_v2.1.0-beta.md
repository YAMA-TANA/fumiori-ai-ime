...
- `Yamatana-AI-IME-v2.1.0-beta-hotfix-20260919-r10.zip`（推奨。joint segment batch＋非同期プリフェッチ＋Mozcプロセスのロック解除待ち／リトライ対応）
- `SHA256SUMS.txt`
...
- r10 では隣接する Mozc セグメントを1回の文脈バッチで共同順位付けします。r9 の安全な hotfix 適用処理も含みます。

### Existing installation

既存 MSI を使っている場合は、次の hotfix ZIP を展開し、正規パスまたは互換パスのスクリプトを管理者 PowerShell から実行してください。

- 推奨: `Yamatana-AI-IME-v2.1.0-beta-hotfix-20260919-r10.zip`
- SHA-256: `3B288D2B14F1B12BEA08D2DA5A87A8E5DE967646823776B53529E18712F7A07A`
- 正規スクリプト: `scripts\apply_hotfix.ps1`
- 互換スクリプト: `scripts\apply\_hotfix.ps1`
- 旧 20260918 / 20260919 / r2 / r3 / r4 / r5 / r6 / r7 / r8 / r9 ZIP は使用しないでください。
